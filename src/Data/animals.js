import echidna from "../assets/images/echidna.jpg";
import quokka from "../assets/images/quokka.jpg";
import tasmanianDevil from "../assets/images/tasmanian-devil.jpg";
import hawksbillTurtle from "../assets/images/hawksbill-turtle.jpg";
import frillNeckedLizard from "../assets/images/frill-necked-lizard.jpg";
import perentie from "../assets/images/perentie.jpg";
import kookaburra from "../assets/images/kookaburra.jpg";
import cassowary from "../assets/images/cassowary.jpg";
import yellowTailedBlackCockatoo from "../assets/images/yellow-tailed-black-cockatoo.jpg";
...
const mammals = allAnimals.filter((animal) => animal.group === "mammals");
const reptiles = allAnimals.filter((animal) => animal.group === "reptiles");
const birds = allAnimals.filter((animal) => animal.group === "birds");

export { mammals, reptiles, birds, allAnimals };
